#!/bin/bash
# This script initializes the PathIQ project for GitHub
...
[ -f "backend/.gitignore" ] && echo "✓ Backend .gitignore exists"
[ -f "frontend/.gitignore" ] && echo "✓ Frontend .gitignore exists"
